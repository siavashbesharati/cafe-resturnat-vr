...
export const uiTranslations: Record<Language, any> = {
  en: {
    ...
    viewInAr: "View in AR",
    chatGreeting: "Hello! I am your Quantivo AI concierge. How can I assist you with the {item} today? (By the way, ask me for a **riddle** to win a discount!)",
  ...
  am: {
    ...
    chatGreeting: "Ողջույն: Ես ձեր Quantivo AI սպասարկողն եմ: Ինչպե՞ս կարող եմ օգնել ձեզ {item}-ի հարցում: (Ի դեպ, հարցրեք ինձ **հանելուկ**՝ զեղչ ստանալու համար:)",
  ...
  ru: {
    ...
    chatGreeting: "Здравствуйте! Я ваш ИИ-консьерж Quantivo. Чем я могу помочь вам с {item} сегодня? (Кстати, попросите у меня **загадку**, чтобы получить скидку!)",
  ...
  tr: {
    ...
    chatGreeting: "Merhaba! Ben Quantivo yapay zeka asistanınız. Bugün {item} hakkında size nasıl yardımcı olabilirim? (Bu arada, indirim kazanmak için benden bir **bilmece** isteyebilirsiniz!)",
  ...
  fa: {
    ...
    chatGreeting: "سلام! من دستیار هوشمند کوانتیوو هستم. امروز چطور می‌توانم در مورد {item} به شما کمک کنم؟ (راستی، می‌توانید از من یک **معما** بخواهید تا کد تخفیف بگیرید!)",
